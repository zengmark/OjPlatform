package com.oj.zengojbackendquestionservice.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.oj.zengojbackendcommon.common.ErrorCode;
import com.oj.zengojbackendcommon.constant.CommonConstant;
import com.oj.zengojbackendcommon.exception.BusinessException;
import com.oj.zengojbackendcommon.utils.SqlUtils;
...
import com.oj.zengojbackendmodel.model.enums.QuestionSubmitLanguageEnum;
import com.oj.zengojbackendmodel.model.enums.QuestionSubmitStatusEnum;
import com.oj.zengojbackendmodel.model.vo.QuestionSubmitVO;
import com.oj.zengojbackendquestionservice.mapper.QuestionSubmitMapper;
...
public class QuestionSubmitServiceImpl extends ServiceImpl<QuestionSubmitMapper, QuestionSubmit>
    ...
    /**
     * 获取查询包装类（用户根据哪些字段查询，根据前端传来的请求对象，得到 mybatis 框架支持的
     * QueryWrapper 类）
     *
    ...
    public QuestionSubmitVO getQuestionSubmitVO(QuestionSubmit questionSubmit, User loginUser) {
        ...
        // 脱敏：仅本人和管理员能看到自己（提交 userId 和登录用户 id 不同）提交的代码
        Long userId = loginUser.getId();
